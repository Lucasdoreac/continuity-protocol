#!/usr/bin/env python3
"""
MCP Continuity Server - Claude Desktop Compatible (FIXED)
...
async def run_server():
    """Run the MCP server - FIXED VERSION"""
    from mcp.server.stdio import stdio_server
    
    # CORREÇÃO: stdio_server() sem parâmetros retorna os streams
    async with stdio_server() as (read_stream, write_stream):
        init_options = InitializationOptions(
            server_name="mcp-continuity",
