#!/bin/bash
# Script para atualizar a configuração do Claude Desktop para usar o servidor unificado
...
# Atualizar o servidor Continuity Protocol para usar o servidor unificado
jq --arg cmd "python3" --arg arg "${CONTINUITY_DIR}/unified-continuity-server.py" --arg desc "Continuity Protocol - Servidor Unificado Completo" '
...
if jq empty "$TMP_FILE" 2>/dev/null; then
    ...
    echo "O servidor Continuity Protocol agora usa: unified-continuity-server.py"
